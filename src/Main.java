import Especies.Cachorro;
import Especies.Passaro;
import Especies.Cavalo;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                switch (escolha) {
                    case 1:
                        cachorro1.escolheRaca("src/Especies/Racas/cachorros.txt");
                    ...
                    case 2:
                        cavalo1.escolheRaca("src/Especies/Racas/cavalos.txt");
                        cavalo1.mostrainfo();
                    ...
                    case 3:
                        passaro1.escolheRaca("src/Especies/Racas/passaros.txt");
                        passaro1.mostrainfo();
